    ...
    if memory_enabled:
        ...
        try:
            ...
            if not fallback_on_error:
                raise
            logger.warning("memory_audit_import_failed_fallback_to_classic",
            ...
            episode_meta = {
                "saved": False,
                "reason": "memory_import_failed_fallback",
            }
        ...
        HybridSearcher = None
        try:
            from app.memory_system.search import HybridSearcher as _HybridSearcher
