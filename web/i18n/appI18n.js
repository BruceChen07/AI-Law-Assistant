export const appI18n = {
  zh: {
    ...
    evidenceMeta: "证据条数",
    queryMeta: "检索查询",
    evidenceListTitle: "检索证据明细",
    evidenceViewHint: "点击展开/收起证据明细，用于交叉核验",
    evidenceEmpty: "暂无证据记录",
    evidenceCidLabel: "引用ID",
    promptMeta: "估算Token",
    taxFocus: "仅输出税务相关",
    taxFocusMeta: "税务聚焦",
    region: "地区",
    ...
    progressDone: "完成",
    progressFailed: "失败",
    llmProgressMeta: "LLM请求",
    llmProgressDynamicTotal: "动态",
    executionPathClassic: "分块审计",
    executionPathMemory: "记忆审计",
  ...
  en: {
    ...
    queryMeta: "Queries",
    evidenceListTitle: "Retrieved Evidence Details",
    evidenceViewHint: "Click to expand/collapse evidence for cross-checking",
    evidenceEmpty: "No evidence records",
    evidenceCidLabel: "Citation ID",
    ...
    llmProgressMeta: "LLM Requests",
    llmProgressDynamicTotal: "dynamic",
    executionPathClassic: "Classic Multipass",
    executionPathMemory: "Memory Audit",
